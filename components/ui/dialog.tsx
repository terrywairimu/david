...
>(({ className, children, ...props }, ref) => {
  ...
  const { "aria-describedby": incomingDescribedBy, ...safeProps } = props
  const describedBy = incomingDescribedBy || autoDescId
  ...
  return (
    <DialogPortal>
      ...
      >
        {!incomingDescribedBy && (
          <DialogDescription id={autoDescId} className="sr-only">
            Dialog content
          </DialogDescription>
        )}
        {children}
