  ...
  const generatePDFForViewing = async () => {
    ...
    try {
      ...
      sectionOrder.forEach((category) => {
        ...
        // In view mode only show Labour Charge rows that were saved (already in itemsInCategory); never add one here (when toggle was off at save, no row was saved)
